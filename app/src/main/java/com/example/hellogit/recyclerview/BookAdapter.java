...
//                .load(mData.get(position).getDrawableResources()) // Mengatur gambar cover dari buku
//                .transform(new CenterCrop(), new RoundedCorners(10)) // Sudah deprecated sih ini
//                .into(holder.imgbook); //Tujuan destinasi
