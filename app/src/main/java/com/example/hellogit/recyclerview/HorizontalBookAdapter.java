...
public class HorizontalBookAdapter extends RecyclerView.Adapter {
    ...
    public HorizontalBookAdapter(ArrayList<Book> mData, Context context, Callback<Books> booksCallback, BookAdapter.ItemClickListener mClickListener, Callback<ImageLinks> ICallback) {
        this.mData = mData;
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = layoutInflater.inflate(R.layout.item_view_horizontal_2, parent, false);
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        ...
        // bind HorizontalBookViewHolder
        HorizontalBookViewHolder horizontalBookViewHolder = (HorizontalBookViewHolder) holder;
        Glide.with(horizontalBookViewHolder.itemView).load(book.getImage())
                ...
                .into(horizontalBookViewHolder.cover_buku_d1);
        horizontalBookViewHolder.judul_buku_d1.setText(book.getTitle());
        if (book.getTitle().length() < 30)
            horizontalBookViewHolder.judul_buku_d1.append("...");
        String author = book.getAuthors();
        horizontalBookViewHolder.penulis_buku_d1.setText(author);
        horizontalBookViewHolder.rating_buku_d1.setRating((float) book.getRating());

        horizontalBookViewHolder.itemView.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    mClickListener.onItemClick(mData.get(position));
                    horizontalBookViewHolder.judul_buku_d1.setText(book.getTitle());
                    horizontalBookViewHolder.penulis_buku_d1.setText(book.getAuthors());
                    horizontalBookViewHolder.rating_buku_d1.setRating((float) book.getRating());
                }
            });
        ...
        horizontalBookViewHolder.judul_buku_d1.setTypeface(semibold);
        horizontalBookViewHolder.penulis_buku_d1.setTypeface(medium);
        }
    ...
    public static final class HorizontalBookViewHolder extends RecyclerView.ViewHolder {
